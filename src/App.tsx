...
export default function App() {
  ...
  //   try {
  //     const tokens = await client.getTokensList(); // Get token list
  ...
  //     console.log("Formatted Amount (BigInt):", formattedAmount.toString());
  ...
  //       intmaxAddress,
  //     };
  //     console.log("Deposit Parameters:", depositParams); // Debugging

  //     // const transactionHash = await client.deposit(depositParams);
  ...
  //     }
  //     console.log("decimals:", token.decimals);
  //     // const formattedAmount = BigInt(Math.floor(parsedAmount * 10 ** token.decimals));
  //     const formattedAmount = BigInt(Math.round(parsedAmount * 10 ** token.decimals));
  //     console.log("Formatted Amount (BigInt):", formattedAmount.toString());
  ...
  //     const withdrawals = await client.fetchPendingWithdrawals(); // Record<WithdrawalsStatus, ContractWithdrawal[]>
